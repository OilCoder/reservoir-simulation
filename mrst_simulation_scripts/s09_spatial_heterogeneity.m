...
% Add field summary statistics
    ...
    rock.meta.field_summary.permeability_stats = struct(...
        'min_m2', min(rock.perm(:,1)), 'max_m2', max(rock.perm(:,1)), ...
        'mean_m2', mean(rock.perm(:,1)), ...
        'min_mD', min(rock.perm(:,1))/9.869233e-16, ...
        'max_mD', max(rock.perm(:,1))/9.869233e-16, ...
        'mean_mD', mean(rock.perm(:,1))/9.869233e-16);

...
The **Simulation Data Catalog** is the comprehensive index of all data generated by the Eagle West Field MRST reservoir simulation. This 15-well, 10-year phased development program generates structured simulation data across 120 monthly timesteps, organized for machine learning applications, real-time dashboards, and technical analysis.
...
| Document | Description | ML Applications |
|----------|-------------|-----------------|
| [**01_Static_Data_Inventory**](./01_Static_Data_Inventory.md) | Grid geometry, rock properties, well trajectories | Spatial feature engineering, geological ML |
| [**02_Dynamic_Data_Inventory**](./02_Dynamic_Data_Inventory.md) | Time-varying pressures, saturations, production rates | Production forecasting, time series ML |
| [**03_Solver_Internal_Data**](./03_Solver_Internal_Data.md) | Newton iterations, convergence metrics, timestep controls | Convergence prediction, stability ML |
| [**04_Derived_Calculated_Data**](./04_Derived_Calculated_Data.md) | Recovery factors, sweep efficiency, flow diagnostics | Performance optimization, analytics ML |
| [**05_Visualization_Outputs**](./05_Visualization_Outputs.md) | Charts, maps, animations, interactive dashboards | Dashboard creation, reporting automation |
| [**06_ML_Ready_Features**](./06_ML_Ready_Features.md) | Pre-processed feature matrices, training datasets | Direct ML model training and validation |
...
3. **Review the Data Organization** to understand structure and scope
...
| **Storage Efficiency** | Optimized organization | Excessive fragmentation | Weekly |
...
```
Data Categories:
├── Dynamic Data: Time-varying simulation results (90% of total)
├── Solver Data: Internal computation metrics (4% of total)
├── Derived Data: Calculated analytics and metrics (3% of total)
├── ML Features: Pre-processed datasets (2% of total)
├── Visualizations: Charts and animations (1% of total)
└── Static Data: Grid and rock properties (<1% of total)
```

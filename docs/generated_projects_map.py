...
TARGET_DIRS = ["mrst_simulation_scripts", "tests", "monitoring", "dashboard"]
...
def get_directory_description(directory: str) -> str:
    ...
    descriptions = {
        ...
        'dashboard': 'Interactive Streamlit dashboard for MRST simulation visualization',
        'monitoring': 'Legacy monitoring system with categorized plot generation'
    }
